...
## License
Hardware design files in this repository are licensed under the CERN Open Hardware Licence Version 2 - Strongly Reciprocal (CERN-OHL-S v2).

Documentation and graphics are licensed under CC BY-SA 4.0 unless otherwise noted.

You may manufacture, modify, distribute, and sell products based on this work, provided that modifications and derivative works remain open under the same license.
